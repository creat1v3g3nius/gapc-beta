...
depends_on: [HOSTING_01_TARGET_ARCHITECTURE, HOSTING_03_OPERATION_MONITORING, HOSTING_04_DISASTER_RECOVERY]
arc: SYSTEM
...
⚠️ Note : `--delete` maintient un miroir. Si tu veux sécuriser, fais 2 jours de `--dry-run` avant.
