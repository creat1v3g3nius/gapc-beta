...
depends_on: [HOSTING_02_BACKUP_RSYNC, HOSTING_03_OPERATION_MONITORING, HOSTING_04_DISASTER_RECOVERY]
arc: SYSTEM
...
## 6) Next step
Planifier un rappel hebdo (dry-run) + mensuel (SMART + test restauration canari).
