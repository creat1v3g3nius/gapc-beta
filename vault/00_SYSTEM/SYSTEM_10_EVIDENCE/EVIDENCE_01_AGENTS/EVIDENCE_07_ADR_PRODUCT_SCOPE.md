...
- Problème : décider si le setup `PRODUCT_00_GAPC_MENTOR` peut être considéré
  finalisé et `FROZEN`
- Contraintes :
...
- Decision : retenir l option B et considérer `PRODUCT_00_GAPC_MENTOR` comme
  `FROZEN` après PASS de `DOD_00` à `DOD_03`, `WORKFLOW_07_TESTS_LLM` et
