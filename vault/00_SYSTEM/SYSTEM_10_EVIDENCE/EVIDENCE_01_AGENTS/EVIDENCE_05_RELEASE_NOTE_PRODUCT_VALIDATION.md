...
- Version : v1.0
- Date : 13-03-2026
- Perimetre : qualification finale du setup `PRODUCT_00_GAPC_MENTOR` sur
  `AnythingLLM + Codex`

## 2) Changements

- Added : pack `EVIDENCE_*` produit complet avec preuves `WS_00`, `WS_01`,
  `WS_02` et `Codex IDE`
...
- revert du lot `PRODUCT_00_GAPC_MENTOR` vers le commit antérieur à la
  qualification
