...
Cadrer la gestion multi-products dans GAPC sans dupliquer `CORE`, `SYSTEM`,
`PACKAGE` ou `PRODUCT`.
...
- v1.4 (15-03-2026) : passage en FROZEN du lot `SETUP_PRODUCT`
...
- v1.1 (13-03-2026) : cartographie de transition `MP_* -> SETUP_PRODUCT_*`

  ajoutee sans renommage effectif.
