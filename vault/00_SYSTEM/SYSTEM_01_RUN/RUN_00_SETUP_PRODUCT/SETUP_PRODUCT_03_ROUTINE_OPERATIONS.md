...
- l execution quotidienne releve de `WORKFLOW_03_START_SESSION`, `WORKFLOW_04_END_SESSION` et `WORKFLOW_10_COMMANDES`.
- les reruns requis sont executes via `WORKFLOW_06_VAULT_HEALTH_CHECK`, `WORKFLOW_07_TESTS_LLM` et `WORKFLOW_08_TESTS_CODEX`.
