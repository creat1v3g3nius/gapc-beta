...
depends_on: [META_01_OUTPUT_PROTOCOL, META_02_SOP_STANDARD_LOOP, META_05_FRONTMATTER, DISCIPLINE_03_DOC_QG, SCRIPT_00_VALIDATOR, SCRIPT_04_DOC_INTEGRITY_CHECKER, FRAMEWORK_00_AMELIORATION_PIPELINE]
arc: SYSTEM
...
Definir le **process de creation** du module utilitaire `frontmatter_utils` dans `00_SYSTEM/03_SCRIPT/`.
...
Le but est de reduire la duplication, stabiliser les erreurs et garder un comportement deterministe.
