...
Ce document décrit **comment utiliser Obsidian** comme noyau documentaire du
framework GAPC :
...
Chaque fichier appartient à une **famille**
(INDEX/WORKFLOW/GIT/SCRIPT/LLM/BACKLOG/PATCH/FAQ/META/DISCIPLINE/
RESTRAINT/TOOLING…).
...
- Mettre les brouillons instables dans `99_CACHE/`

  (ou legacy `04_CACHE/` si encore present), puis migrer/archiver
