...
Ce document sert de charte rédactionnelle et conceptuelle pour les fichiers du
framework.
...
`(INDEX|WORKFLOW|GIT|LLM|BACKLOG|PATCH|META|FIELD|RESTRAINT|`
`TOOLING|RUBRIC|SOT...)`
...
- tout document visuel “critique” doit avoir un **companion** `.md`

  (résumé + points d’action) pour l’indexation RAG.
