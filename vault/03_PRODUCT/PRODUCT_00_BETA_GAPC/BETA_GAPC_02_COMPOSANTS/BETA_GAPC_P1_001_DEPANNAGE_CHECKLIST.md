...
depends_on: [GIT_01_ESSENTIEL, GIT_02_BRANCH_POLICY, BETA_GAPC_COMPOSANTS_00_BACKLOG]
arc: PRODUCT
...
```
Vérif : `git branch --show-current` renvoie `work/recover-detached` (ou branche cible).
