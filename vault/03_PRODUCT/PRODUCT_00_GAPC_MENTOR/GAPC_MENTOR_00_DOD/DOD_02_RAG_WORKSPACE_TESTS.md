...
depends_on: [DOD_00_PRODUCT_VALIDATION, LLM_01_INGESTION_PROTOCOL, LLM_02_PERMISSION_SECURITY, DISCIPLINE_02_RAG_QG, GAPC_DISCIPLINE_02_RAG_QG, GAPC_TOOLING_PIPELINE_01_WORKSPACE_RULES]
arc: PRODUCT
...
Exemple valide :
- `Sources utilisees : GAPC_DISCIPLINE_00_RAG_PROFILE.md (PACKAGE), OPS_05_CO_DOD.md (PRODUCT)`
