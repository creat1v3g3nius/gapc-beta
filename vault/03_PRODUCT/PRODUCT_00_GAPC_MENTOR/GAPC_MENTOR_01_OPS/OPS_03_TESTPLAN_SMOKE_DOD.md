...
depends_on: [OPS_02_SPEC_DOD, DOD_02_RAG_WORKSPACE_TESTS, TPL_04_TEST_PLAN_SMOKE]
arc: PRODUCT
...
# OPS_03 - TestPlan Smoke DoD

## Objet
Valider que le smoke plan couvre le setup minimal `mentor documentaire + Codex execution`.
