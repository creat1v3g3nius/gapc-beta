---
id: OPS_06_READY_TO_FREEZE_CHECKLIST
type: DOD
...
depends_on: [DOD_03_RELEASE_FREEZE, OPS_00_BACKLOG_PRODUCT, OPS_00_BACKLOG_CO, OPS_01_PRD_DOD, OPS_02_SPEC_DOD, OPS_03_TESTPLAN_SMOKE_DOD, OPS_04_ACTION_DOC_DOD, OPS_05_CO_DOD, CHECKLIST_03_READY_TO_FREEZE, GAPC_TOOLING_CHECKLIST_01_READY_TO_FREEZE_ADDON]
arc: PRODUCT
...
# OPS_06 - Ready To Freeze Checklist

## Objet
Fournir la checklist produit de reference pour `PRODUCT_00_GAPC_MENTOR`.

## Checklist P0
- [x] backlog product present
- [x] backlog CO present
- [x] PRD controle via `OPS_01_PRD_DOD`
- [x] spec controlee via `OPS_02_SPEC_DOD`
- [x] smoke plan controle via `OPS_03_TESTPLAN_SMOKE_DOD`
- [x] action doc controlee via `OPS_04_ACTION_DOC_DOD`
- [x] CO atomique controle via `OPS_05_CO_DOD`
...
- v1.5 (13-03-2026) : remplace `RUN_08_TESTS_CODEX` par `EVIDENCE_04_CODEX_IDE` dans les preuves de gel.
- v1.4 (13-03-2026) : passe la checklist de gel en `READY_TO_FREEZE`.
- v1.3 (13-03-2026) : coche les controles `OPS_01` a `OPS_05`, passe la checklist a `Verdict: OK` et ajoute `RUN_08_TESTS_CODEX` dans la preuve.
...
- v1.0 (10-03-2026) : creation de la checklist produit `READY_TO_FREEZE` pour `PRODUCT_00_GAPC_MENTOR`.
