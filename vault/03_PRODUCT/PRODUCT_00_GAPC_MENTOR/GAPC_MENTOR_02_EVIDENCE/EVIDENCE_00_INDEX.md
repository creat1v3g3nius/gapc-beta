...
depends_on: [DOD_00_PRODUCT_VALIDATION, DOD_01_PRODUCT_THIN_SLICE, DOD_02_RAG_WORKSPACE_TESTS, DOD_03_RELEASE_FREEZE, OPS_06_READY_TO_FREEZE_CHECKLIST, RUN_07_TESTS_LLM, EVIDENCE_01_WS00_RULESONLY, EVIDENCE_02_WS01_PACKAGESCOPED, EVIDENCE_03_WS02_PRODUCTSCOPED, EVIDENCE_04_CODEX_IDE, EVIDENCE_05_RELEASE_NOTE_PRODUCT_VALIDATION, EVIDENCE_06_REVIEW_PRODUCT_VALIDATION, EVIDENCE_07_ADR_PRODUCT_SCOPE]
arc: PRODUCT
...
## Delta
- added : pack `EVIDENCE_*` produit pour tracer les reruns de qualification mentor + Codex
- changed : aucun
- fixed : absence de preuves explicites de qualification workspace et Codex dans le lot produit
...
- v1.1 (13-03-2026) : etend l index evidence a Codex, ajoute le format trace issu du modele `EXTENSION_04_EVIDENCE_PACK`, et passe le target a `READY_TO_FREEZE`.
- v1.0 (12-03-2026) : creation de l index evidence produit pour la qualification `WS_00`, `WS_01` et `WS_02`.
