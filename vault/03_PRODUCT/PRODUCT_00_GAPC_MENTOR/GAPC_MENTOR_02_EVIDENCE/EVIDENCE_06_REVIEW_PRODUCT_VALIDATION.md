...
depends_on: [DOD_00_PRODUCT_VALIDATION, DOD_01_PRODUCT_THIN_SLICE, DOD_02_RAG_WORKSPACE_TESTS, DOD_03_RELEASE_FREEZE, OPS_01_PRD_DOD, OPS_02_SPEC_DOD, OPS_03_TESTPLAN_SMOKE_DOD, OPS_04_ACTION_DOC_DOD, OPS_05_CO_DOD, OPS_06_READY_TO_FREEZE_CHECKLIST]
arc: PRODUCT
...
# EVIDENCE_06 - Review Product Validation
...
- [x] Sans oral
- [x] No-secrets / no-PII
- [x] Hiérarchie d autorité alignée `CORE -> PACKAGE -> PRODUCT -> SYSTEM -> CACHE`
