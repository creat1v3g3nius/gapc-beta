...
depends_on:
  ...
  - KNOWLEDGE_01_AI_CODING_LIST
  - KNOWLEDGE_03_LLM_PLATFORM_LIST
arc: PACKAGE
...
Définir une **allowlist** d’outils autorisés/recommandés pour exécuter GAPC
(réduction du bruit + conformité).
