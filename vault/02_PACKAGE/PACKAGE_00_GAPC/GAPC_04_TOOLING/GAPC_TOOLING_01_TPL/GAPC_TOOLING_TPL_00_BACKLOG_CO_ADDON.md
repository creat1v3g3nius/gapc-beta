...
depends_on: [TPL_03_BACKLOG_CO, GAPC_DISCIPLINE_03_SCOPE_CLASSIFIER, GAPC_DISCIPLINE_04_RISK_REGISTER, GAPC_DISCIPLINE_01_GEL_RULES, CONSTRAINT_00_GUARD_RAILS]
arc: PACKAGE
...
## Objet
Ajouter des champs **spécifiques GAPC** au template CORE `TPL_03_BACKLOG_CO` (sans duplication).
...
- si `GAPC_RiskID` critique (score 6–9) → mitigation + owner obligatoires (dans Risk Register)
