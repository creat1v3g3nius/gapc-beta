...
depends_on: [TPL_10_RELEASE_NOTE, GAPC_DISCIPLINE_01_GEL_RULES, GAPC_DISCIPLINE_04_RISK_REGISTER, GAPC_TOOLING_TPL_02_BETA_EVIDENCE_PACK, CONSTRAINT_03_SECRETS_POLICY]
arc: PACKAGE
...
## Objet
Ajouter des sections **spécifiques GAPC** au template CORE `TPL_10_RELEASE_NOTE` (sans duplication).
