...
## Objet
Définir **comment le package GAPC s’applique** aux pipelines CORE, sans créer de procédures “beta” dans le PACKAGE.

- CORE fournit : phases, gates, gel générique.
- GAPC ajoute : priorisation (ScopeClassifier GAPC), risques/signaux GAPC, critères de gel GAPC.
