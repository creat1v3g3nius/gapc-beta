...
depends_on: [META_00_HANDBOOK, META_01_OUTPUT_PROTOCOL, META_02_SOP_STANDARD_LOOP, DISCIPLINE_01_GEL_RULES, CONSTRAINT_00_GUARD_RAILS, GAPC_TOOLING_PIPELINE_01_PACKAGE, GAPC_DISCIPLINE_01_GEL_RULES, GAPC_DISCIPLINE_03_SCOPE_CLASSIFIER, GAPC_DISCIPLINE_04_RISK_REGISTER]
arc: PACKAGE
...
GAPC fournit :
- une architecture de production (Vault + repo + mentor),
...
- pipelines de validation beta (DoD) → PRODUCT_00_GAPCBETA
...
- Pipelines GAPC : `GAPC_TOOLING_PIPELINE_01_PACKAGE`
- DoD workspace : `**PRODUCT_00_BETA_GAPC/BETA_GAPC_01_DOD**` (référence)
