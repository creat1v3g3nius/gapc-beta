...
depends_on: [DISCIPLINE_01_GEL_RULES, DISCIPLINE_03_DOC_QG, CONSTRAINT_00_GUARD_RAILS, ASSO_DISCIPLINE_05_RISK_REGISTER]
arc: PACKAGE
...
## ASSO_FROZEN (P0)
READY_TO_FREEZE PASS + amendements contrôlés + version bump + changelog + reproductibilité “sans oral”.
