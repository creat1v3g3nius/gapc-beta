...
depends_on: [CONSTRAINT_00_GUARD_RAILS, META_01_OUTPUT_PROTOCOL, META_02_SOP_STANDARD_LOOP]
arc: PACKAGE
...
## Objet
Profil de `PACKAGE_01_ASSO` : rôle, périmètre, règles d’extension, invariants P0.

## Rôle
Vérité métier “association 1901” : gouvernance, conformité, communication, lexique.
