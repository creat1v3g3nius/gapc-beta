...
depends_on: [ASSO_CONSTRAINT_01_LEGAL_BASELINE_1901, CONSTRAINT_04_DECISION_TRACEABILITY_POLICY, TPL_02_ADR_LITE]
arc: PACKAGE
...
## Objet
Limiter les risques de confusion et de conflit d’intérêt (association ↔ intérêts privés).
