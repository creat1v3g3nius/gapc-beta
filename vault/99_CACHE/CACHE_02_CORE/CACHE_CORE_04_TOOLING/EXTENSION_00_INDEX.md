...
CORE strict : règles d’usage + garde-fous, sans procédures détaillées ni secrets.
...
## Changelog
- v1.2 (04-03-2026) : FROZEN + depends_on minimisé et dédupliqué + déplacement dans CACHE.
