...
## Objet
Index des listes “KNOWLEDGE” (référentiels) destinées au mentor et à la production.
...
- [[KNOWLEDGE_03_LLM_PLATFORM_LIST]] — plateformes LLM/RAG (workspaces, ingestion)
...
- v1.2 (04-03-2026) : correction heading + `depends_on` du frontmatter + déplacement du fichier dans CACHE.
