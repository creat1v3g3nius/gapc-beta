...
Valider que **PRODUCT_00_GAPCBETA** prouve que le package **GAPC** est
utilisable pour produire un premier product :
...
> Le package reste la vérité de base. Ce product contient les **preuves**
  (evidence).
