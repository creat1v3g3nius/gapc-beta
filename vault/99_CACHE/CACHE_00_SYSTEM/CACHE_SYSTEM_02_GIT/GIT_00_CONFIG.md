...
`00_SYSTEM/01_CORE/02_PACKAGE/03_PRODUCT/04_CACHE`) telle que décrite dans
`INDEX_01`
...
> astuce:  utiliser une adresse “no-reply” si tu veux éviter une adresse perso
  dans l’historique.
...
Piège #1 : ouvrir **le mauvais dossier**, ce qui “casse” Git et crée de la
confusion.
