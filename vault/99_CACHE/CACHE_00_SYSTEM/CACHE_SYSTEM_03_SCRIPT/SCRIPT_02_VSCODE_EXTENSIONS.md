...
Objet : décision P2.1 sur les extensions VS Code (recommandées vs optionnelles)
avec règle de retrait si bruit/instabilité.
...
Raison : validation YAML/frontmatter utile et directement alignée avec la
qualité documentaire du vault.
