...
Invariants transversaux de gestion des risques : structure, scoring, no-secrets, traçabilité, extension.  
...
- structure minimale : id, titre, description, catégorie, P, I, score, mitigation, signal, owner, statut
