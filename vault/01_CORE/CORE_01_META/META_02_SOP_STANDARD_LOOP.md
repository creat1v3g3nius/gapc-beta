...
Permet de définir la **boucle standard** que le mentor LLM (AnythingLLM) doit
appliquer à **chaque interaction**, en cohérence avec :
...
Cette SOP est **normative** (CORE). Les procédures utilisateur détaillées vivent
dans SYSTEM.
