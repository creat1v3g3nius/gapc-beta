...
## Changelog
- v1.4 (15-03-2026) : explicite le format de nommage des fichiers et IDs de sous-famille, et harmonise les exemples standard / sous-famille.
- v1.3 (15-03-2026) : formalise la convention H1 canonique pour familles et sous-familles, et clarifie l alignement `id` / nom de fichier.
