...
type: <INDEX|RUN|GIT|SCRIPTS|LLM|BACKLOG|PATCH|FAQ|META|DISCIPLINE|CONSTRAINT|TOOLING>
...
depends_on: [CONSTRAINT_00_GUARDRAILS, CONSTRAINT_02_NONDUPLICATIONPOLICY]
arc: CORE
