---
id: CHECKLIST_04_FROZEN_AMENDMENT
type: TOOLING
title: FrozenAmendment
version: v1.2
status: FROZEN
created: 01-03-2026
updated: 04-03-2026
tags: [tooling, checklist, frozen, amendment, core]
depends_on:
...
# CHECKLIST_04 - Frozen Amendment Checklist (CORE)

## Objet

Amender un artefact **FROZEN** de manière contrôlée.

- [ ] Intention unique (1 changement)
- [ ] Modification tracée (référence décision si structurante)
- [ ] Version bump effectué si changement substantiel
- [ ] Changelog mis à jour si applicable
- [ ] Gates applicables re-passées (doc/code/rag)
- [ ] Backout possible
- [ ] No-secrets confirmé

## Output attendu

- Patch + validation + statut maintenu FROZEN
