...
## Objet
Référentiel de festivals (typologie + repères) sous forme de liste **RAG-friendly**.  
Pas de procédure (dates précises à vérifier selon l’année), pas de données personnelles.
