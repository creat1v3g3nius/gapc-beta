---
id: PIPELINE_03_BACKLOG_COMPOSANTS
type: TOOLING
...
# PIPELINE_03 — Backlog Composants (CO) (CORE)

## Objet
Standardiser un backlog “composants” = liste de CO atomiques, exécutable sans dérive.
